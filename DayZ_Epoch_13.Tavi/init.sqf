...
call compile preprocessFileLineNumbers "OPTIONS\scriptcontrol.sqf";
...
if (!isDedicated) then {
execVM "DAYZ_CODE\COMPILE\playerHud.sqf";//AsReMix Player HUD
   ...
   [false] execVM "OPTIONS\colorsettings.sqf";
