...
SC_fnc_removeCoins = compile preprocessFileLineNumbers "DAYZ_CODE\COMPILE\SC_fnc_removeCoins.sqf";
SC_fnc_addCoins = compile preprocessFileLineNumbers "DAYZ_CODE\COMPILE\SC_fnc_addCoins.sqf";
...
player_gearSet	=	compile preprocessFileLineNumbers "DAYZ_CODE\COMPILE\player_gearSet.sqf";
