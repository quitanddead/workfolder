class ATM_RscScrollBar
{
	...
	thumb = "IMG\GUI\menu\thumb_ca.paa";
	arrowEmpty = "IMG\GUI\varrowEmpty_ca.paa";
	arrowFull = "IMG\GUI\menu\arrowFull_ca.paa";
	border = "IMG\GUI\menu\border_ca.paa";
	shadow = 0;
	scrollSpeed = 0.06;
	width = 0;
	height = 0;
...
class ATM_RscTree {
	...
	expandedTexture = "IMG\GUI\menu\expandedTexture_ca.paa";
	hiddenTexture = "IMG\GUI\menu\hiddenTexture_ca.paa";
	rowHeight = 0.0439091;
	color[] = {1, 1, 1, 1};
...
class ATM_RscShortcutButton {
	...
	animTextureDefault = "IMG\GUI\menu\normal_ca.paa";
	animTextureNormal = "IMG\GUI\menu\normal_ca.paa";
	animTextureDisabled = "IMG\GUI\menu\normal_ca.paa";
	animTextureOver = "IMG\GUI\menu\over_ca.paa";
	animTextureFocused = "IMG\GUI\menu\focus_ca.paa";
	animTexturePressed = "IMG\GUI\menu\down_ca.paa";
	periodFocus = 1.2;
	periodOver = 0.8;
	class HitZone
	{
...
class ATM_RscShortcutButtonMain : ATM_RscShortcutButton {
	...
	animTextureNormal = "IMG\GUI\main\normal_ca.paa";
	animTextureDisabled = "IMG\GUI\main\disabled_ca.paa";
	animTextureOver = "IMG\GUI\main\over_ca.paa";
	animTextureFocused = "IMG\GUI\main\focus_ca.paa";
	animTexturePressed = "IMG\GUI\main\down_ca.paa";
	animTextureDefault = "IMG\GUI\main\normal_ca.paa";
	period = 0.5;
	font = "Zeppelin32";
...
class ATM_RscListBox 
{
	...
	arrowFull = "IMG\GUI\menu\arrowFull_ca.paa";
	arrowEmpty = "IMG\GUI\menu\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	rowHeight = 0.04;
	color[] = {0.7, 0.7, 0.7, 1};
	colorActive[] = {0,0,0,1};
...
class ATM_RscXSliderH 
{
	...
	arrowEmpty = "IMG\GUI\slider\arrowEmpty_ca.paa";
	arrowFull = "IMG\GUI\slider\arrowFull_ca.paa";
	border = "IMG\GUI\slider\border_ca.paa";
...
class ATM_RscHTML {
	...
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	prevPage = "IMG\GUI\menu\arrow_left_ca.paa";
	nextPage = "IMG\GUI\menu\arrow_right_ca.paa";
	shadow = 2;
	class H1 {
		font = "Zeppelin32";
		fontBold = "Zeppelin32";
...
class ATM_RscCombo {
	...
	arrowFull = "IMG\GUI\menu\arrowFull_sca.paa";
	arrowEmpty = "IMG\GUI\menu\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	color[] = {1, 1, 1, 1};
	colorActive[] = {1, 0, 0, 1};
